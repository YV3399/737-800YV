...
var aileronAvail = props.globals.initNode("/systems/hydraulic/ail-active", 0, "DOUBLE");
var elevatorAvail = props.globals.initNode("/systems/hydraulic/elev-active", 0, "DOUBLE");
